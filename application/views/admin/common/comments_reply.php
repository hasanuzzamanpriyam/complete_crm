...
if (!empty($comment_reply_details)) {
    foreach ($comment_reply_details as $v_reply) {
        ?><div id="<?php echo $comment_type . "-reply-comment-form-container-" . $v_reply->task_comment_id ?>"> <div class="col-sm-1"></div> <div class="mb-mails col-sm-11"><img alt="Mail Avatar" src="<?php echo base_url(get_avatar_url($v_reply->avatar ?? null)) ?>" class="mb-mail-avatar pull-left"> <div class="mb-mail-date pull-right"><?= time_ago($v_reply->comment_datetime) ?>
