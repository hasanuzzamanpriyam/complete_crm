        ...
        <div class="d-header clearfix" style="margin-bottom: 29px;">
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    if (!empty($sales_info->start_date)) {
                                        ...
                                        ?>
                                        <div class="invoice-date"><b><?= $start_date[0] ?>: </b><?= $start_date[1] ?>
                                        </div>
                                    <?php }
                                    ...
                                    if (!empty($sales_info->sales_agent)) {
                                        ...
                                        ?>
                                        <div class="invoice-date"><b><?= $sales_agent[0] ?>: </b><?= $sales_agent[1] ?>
                                        </div>
                                    <?php }
            ...
            <table class="clearfix" style="margin-bottom: 15px;">
                <tr>
                    <td>
                        <div>
                            <b style="color : #010F1C"><?= (!empty($sales_info->company_heading) ? $sales_info->company_heading : lang('customer') . ' : ') ?>
                                :</b>
                            ...
                            <?php if (empty($delivery)) { ?>
                                <div class="invoice-total-box">
                                    <div class="invoice-total-inner">
                                        <p><?= lang('sub_total') ?>
                                            :<span><?= $sales_info->sub_total ? display_money($sales_info->sub_total) : '0.00' ?></span>
                                        </p>
                                        ...
                                        <?php if ($sales_info->discount > 0) : ?>
                                            ...
                                            <p><?= lang('discount') ?> :
                                                ...
                                                %) :
                                                <span><?= $sales_info->discount ? display_money($sales_info->discount) : '0.00' ?></span>
                                            </p>
                                        ...
                                        if (!empty($tax_info)) {
                                            ...
                                            if (!empty($tax_name)) {
                                                foreach ($tax_name as $t_key => $v_tax_info) {
                                                    ...
                                                    <p><?= $tax[0] . ' (' . $tax[1] . ' %)' ?> :
                                                        <span><?= display_money($total_tax[$t_key]); ?></span></p>
                                        ...
                                        <?php if ($tax_total > 0) : ?>
                                            ...
                                            <p><?= lang('total') . ' ' . lang('tax') ?>:
                                                <span><?= display_money($tax_total); ?></span></p>
                                        ...
                                        <?php if ($sales_info->adjustment > 0) : ?>
                                            ...
                                            <p><?= lang('adjustment') ?>:
                                                <span><?= display_money($sales_info->adjustment); ?></span></p>
                                        ...
                                        <div class="invoice-total-footer">
                                            <h4 style="margin: 0;"><?= lang('total') ?> :
                                                <span><?= display_money($sales_info->total, $currency->symbol) ?></span>
                                            </h4>
                                        </div>
                                        ...
                                        if (!empty($paid_amount) && $paid_amount > 0) {
                                            ...
                                            if ($paid_amount > 0) {
                                                ...
                                                <p><?= lang('paid_amount') ?>:
                                                    <span><?= display_money($paid_amount, $currency->symbol); ?></span>
                                                </p>
                    ...
                    if (!empty($invoice_view) && $invoice_view > 0) {
                        ...
                        <div class="panel panel-custom" style="margin-top: 20px">
                            <div class="panel-heading"
                                 style="border:1px solid #dde6e9;border-bottom: 2px solid #57B223;">
                                    ...
                                    foreach ($all_items as $key => $v_item) :
                                        ...
                                        <tr>
                                            ...
                                            <td width="20%" class="unit" style="text-align: right"><?php
                                                ...
                                                ?></td>
                                            <td class="unit"
                                                style="text-align: right"><?= display_money($tax_amount) ?></td>
                                            <td class="unit"
