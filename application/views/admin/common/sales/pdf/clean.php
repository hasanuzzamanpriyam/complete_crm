    ...
    <div class="preview-main client-preview clearfix" style="padding: 30px;">
        ...
        <div class="d-header clearfix">
            ...
            <table>
                <tr>
                    <td>
                        <div class="text-uppercase" style="margin-bottom: 5px;">
                            <strong><?= (!empty($sales_info->company_heading) ? $sales_info->company_heading : lang('customer') . ' : ') ?>
                                :</strong></div>
                    ...
                    <table class="j-table table-bordered" style="border: 0;">
                        ...
                        if (!empty($all_items)) :
                            foreach ($all_items as $key => $v_item) :
                                ...
                                <tr class="sortable item" data-item-id="<?= $v_item->$itemId ?>">
                                    ...
                                    <td>
                                        <div class="text-end"
                                             style="margin-top: 10.5px; margin-bottom:10.5px;font-weight: 500;"><?= $item_name ?>
                        ...
                        <?php if (empty($delivery)) { ?>
                            ...
                            <tr>
                                ...
                                <td colspan="2"
                                    class="text-end"><?= display_money($sales_info->total, $currency->symbol) ?></td>
                            </tr>
                            ...
                            if (!empty($paid_amount) && $paid_amount > 0) {
                                ...
                                if ($paid_amount > 0) {
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2"
                                            class="text-end"> <?= display_money($paid_amount, $currency->symbol); ?></td>
                                    </tr>
                            ...
                            if (!empty($paid_amount) && $paid_amount > 0) { ?>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"
                                        class="text-end"> <?= display_money(($invoice_due), $currency->symbol); ?></td>
                                </tr>
                            <?php } ?>
                        <?php } ?>
