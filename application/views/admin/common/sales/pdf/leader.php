...
<div class="invoice-preview-inner clearfix panel panel-custom"
     style="padding: 1.25rem; font-family: 'IBM Plex Sans', sans-serif;">
    <div class="preview-main client-preview clearfix">
        <div class="d-header clearfix">
            <table class="clearfix">
                ...
                <tr>
                    <td>
                        <p class="m-0"><span class="fa fa-envelope-o"
                                             style="margin-right : 5px"></span> <?= (!empty(config_item('company_email')) ? config_item('company_email') : '') ?>
                        </p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p class="m-0"><span class="fa fa-phone"
                                             style="margin-right : 5px"></span> <?= (!empty(config_item('company_email')) ? config_item('company_phone') : '') ?>
                        </p>
                    </td>
                </tr>
            </table>
        ...
        <table class="address-table" style="margin-bottom: 20px;font-size: 13px;">
            ...
            <tr>
                <td style="padding-top: 20px; vertical-align: top;">
                    <h5 class="font-size-15 m-0" style="font-weight : 600; margin-bottom: 10px"><?= lang('our_info') ?>
                        :</h5>
                ...
                <td style="padding-top: 20px;vertical-align: top;text-align: right;">
                    ...
                    if (!empty($sales_info->start_date)) {
                        ...
                        <div class="invoice-date"><b style="color : #010F1C"><?php echo $start_date[0]; ?>
                                : </b><?php echo $start_date[1]; ?></div>
                    ...
                    if (!empty($sales_info->end_date)) {
                        ...
                        <div class="invoice-date"><b style="color : #010F1C"><?php echo $end_date[0]; ?>
                                : </b><?php echo $end_date[1]; ?></div>
                    ...
                    if (!empty($sales_info->sales_agent)) {
                        ...
                        <div class="invoice-date"><b style="color : #010F1C"><?php echo $sales_agent[0]; ?>
                                : </b><?php echo $sales_agent[1]; ?></div>
                    ...
                    if (!empty($sales_info->status)) {
                        ...
                        <div class="invoice-date"><b style="color : #010F1C"><?php echo $status[0]; ?>
                                : </b><?php echo $status[1]; ?></div>
                ...
                <td>
                    <div class="bill_to" style="margin-top: 20px;">
                        <h5 class="font-size-15 m-0"
                            style="font-weight : 600; margin-bottom: 10px"><?= (!empty($sales_info->company_heading) ? $sales_info->company_heading : lang('customer') . ' : ') ?>
                            :</h5>
                    ...
                    <table class="f-table items align-middle">
                        ...
                        <?php if (empty($delivery)) { ?>
                            ...
                            if (!empty($tax_info)) {
                                ...
                                if (!empty($tax_name)) {
                                    foreach ($tax_name as $t_key => $v_tax_info) {
                                        ...
                                        <tr>
                                            <th colspan="5"
                                                class="border-0 text-end"><?= $tax[0] . ' (' . $tax[1] . ' %)' ?></th>
                            ...
                            <?php if ($tax_total > 0) : ?>
                                <tr>
                                    <th colspan="5"
                                        class="border-0 text-end"><?= lang('total') . ' ' . lang('tax') ?></th>
        ...
        <?php if (empty($sales_info->item_layout)) { ?>
            ...
            if (!empty($all_payment_info)) { ?>
                <div style="margin-top:20px; font-weight : 400">
                    ...
                    <table style="width:100%;margin-bottom:35px;table-layout:fixed;" cellpadding="0" cellspacing="0"
                           border="0">
                        <thead>
