            ...
            <div class="panel-body">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input required type="text" placeholder="<?= lang('enter_your') . ' ' . lang('purchase_key') ?>"
                               class="form-control" name="purchase_key" value=""/>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="purchase_key"><?= lang('envato_username') ?></label>
                        <input required type="text" placeholder="unique_coder" class="form-control" name="buyer"
                               value=""/>
                    </div>
                </div>
            ...
            if (purchase_key != '' && buyer != '') {
                ...
                $.post('<?= base_url() ?>admin/auto_update', {
                    ...
                    if (res) {
                        ...
                        $.post('<?= base_url() ?>admin/auto_update/database', {
                            auto_update: true
                        }).done(function (res) {
