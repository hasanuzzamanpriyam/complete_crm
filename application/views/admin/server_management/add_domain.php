...
<div class="row">
    <div class="col-md-12">
        <div class="card erp-card">
            <div class="card-body">
                <form method="post" action="<?= base_url('admin/server_management/add_domain' . (!empty($domain_info) ? '/' . $domain_info->id : '')) ?>" class="erp-form" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3" id="domain_notification_days_wrapper">
                            <div class="form-group">
                                <label style="font-size: 11px; color: #777;">Days Before</label>
                                <input type="number" name="notification_days" class="form-control input-sm" value="<?= !empty($domain_info) ? $domain_info->notification_days : 7 ?>">
                            </div>
                        </div>
                        <div class="col-md-3" id="domain_notification_unit_wrapper">
                            <div class="form-group">
                            ...
                            <div id="custom_fields_container">
                                ...
                                ?>
                                        <div class="row custom-field-row mb-2">
                                            <div class="col-md-3">
                                                <input type="text" name="custom_field_label[<?= $index ?>]" class="form-control" placeholder="Label" value="<?= htmlspecialchars($field['label']) ?>">
                                            </div>
                                            <div class="col-md-3">
