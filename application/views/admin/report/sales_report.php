                ...
                <div class="row">
                    <div class="col-sm-3">
                        ...
                        <section class="panel panel-info">
                            <div class="panel-body">
                                <div class="clear">
                                    <span class="text-dark"><?= lang('paid_this_year') ?></span>
                                    <small class="block text-danger pull-right">
                                        <strong>
                        ...
                        <section class="panel panel-info">
                            <div class="panel-body">
                                <div class="clear">
                                    <span class="text-dark"><?= lang('paid') . ' ' . lang('last_month') ?></span>
                                    <small class="block text-danger pull-right ">
                                        <?php
                        ...
                        <section class="panel panel-info">
                            <div class="panel-body">
                                <div class="clear">
                                    <span class="text-dark"><?= lang('total') . ' ' . lang('payments') ?></span>
                                    <small
                                            class="block text-danger pull-right"><?= count(array($this->db->get('tbl_payments')->result())) ?></small>
                                </div>
                            </div>
                        </section>
                    </div>
