    ...
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content bg-white">
            ...
            <div class="tab-pane active" id="create">
                <form role="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data" id="form" action="<?php echo base_url(); ?>admin/items/saved_items/<?php
                                                                                                                                                                            if (!empty($items_info)) {
                    ...
                    <div class="col-sm-7">
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 col-md-3 col-sm-3 control-label"><?= lang('code') ?> <span class="text-danger">*</span></label>
                            <div class="col-lg-9">
                                <input type="text" class="form-control" value="<?php
                                                                                if (!empty($items_info)) {
                        ...
                        <?php } ?>
                        <div class="form-group">
                            <label for="field-1" class="col-sm-3 col-md-3 col-sm-3 control-label"><?= lang('manufacturer') ?></label>
                            <div class="col-sm-5">
                                <div class="input-group">
                                    ...
                                    ?>
                                    <div class="input-group-addon" title="<?= lang('new') . ' ' . lang('manufacturer') ?>" data-toggle="tooltip" data-placement="top">
                                        <a data-toggle="modal" data-target="#myModal" href="<?= base_url() ?>admin/items/manufacturer"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        if (!empty($warehouse)) { ?>
                            <div class="form-group">
                                <label for="field-1" class="col-sm-3 col-md-3 col-sm-3 control-label"><?= lang('warehouse') ?><span class="text-danger">*</span></label>
                                <div class="col-sm-5">
                                    <div class="input-group">
                                        <?php
                                        // $selected = (!empty($items_info->warehouse_id) ? $items_info->warehouse_id : '');
                                        $selected = (!empty($check_assign_warehouse) ? $check_assign_warehouse  : '');
                                        echo form_dropdown('warehouse_id', $warehouseList, $selected, array('class' => 'form-control select_box required="required"', 'id' => 'select_warehouse', 'style' => 'width:100%'));
                                        ?>
                                        <div class="input-group-addon" title="<?= lang('new') . ' ' . lang('warehouse') ?>" data-toggle="tooltip" data-placement="top">
                                            <a data-toggle="modal" data-target="#myModal_lg" href="<?= base_url() ?>admin/warehouse/create/0/inline"><i class="fa fa-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 col-md-3 col-sm-3 control-label"><?= lang('cost_price') ?> <span class="text-danger">*</span></label>
                            <div class="col-lg-9">
                                <input type="number" data-parsley-type="number" step="0.01" class="form-control" value="<?php
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input type="number" data-parsley-type="number" step="0.01" class="form-control" value="<?php
                                                                                                                        if (!empty($warehouse_product_info)) {
                                                                                                                            echo $warehouse_product_info->quantity;
                                                                                                                        }
                        ...
                        <script>
                            $(document).ready(function() {
                                $('#select_warehouse').on('change', function() {
                                    ...
                                    var item_id = '<?= $items_info->saved_items_id ?>';
                                    $.ajax({
                                        url: '<?= base_url() ?>admin/items/get_warehouse_product',
                                        type: 'POST',
                                        data: {
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group">
                                    ...
                                    ?>
                                    <div class="input-group-addon" title="<?= lang('new') . ' ' . lang('item') . ' ' . lang('group') ?>" data-toggle="tooltip" data-placement="top">
                                        <a data-toggle="modal" data-target="#myModal" href="<?= base_url() ?>admin/items/items_group"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
