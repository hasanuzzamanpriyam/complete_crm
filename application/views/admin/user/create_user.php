                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="name" value="<?php echo $user_login_details->name; ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="email"
                                               value="<?php echo $user_login_details->email; ?>" class="form-control"
                                               placeholder="Email" required/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="field-1" class="col-sm-3 control-label">Login<span
                                                class="required">*</span></label>

                                    <div class="col-sm-8">
                                        <input type="text" name="user_name"
                                               value="<?php echo $user_login_details->user_name; ?>"
                                               class="form-control" onchange="check_user_name(this.value)"
                                ...
                                <div class="form-group">
                                    <label for="field-1" class="col-sm-3 control-label">Type of User<span
                                                class="required">*</span></label>

                                    <div class="col-sm-8">
                                        <select id="user_type" name="flag" class="form-control" required>
                                            <option value="" <?php echo $user_login_details->flag == 3 ? 'selected' : '' ?>>
                                                Select User Type
                                            </option>
                                            <option <?php echo $user_login_details->flag == 1 ? 'selected' : '' ?>
                                                    value="1">Admin
                                            </option>
                                            <option <?php echo $user_login_details->flag == 0 ? 'selected' : '' ?>
                                                    value="0">User
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-sm-offset-3 col-sm-8">
                                    <button type="submit" id="sbtn"
                                            class="btn btn-primary"><?php echo !empty($employee_id) ? 'Update User' : 'Create User' ?></button>
                                </div>
