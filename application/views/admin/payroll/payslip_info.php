            ...
            <div align="center">
                ...
                <table class="tbl_total">
                    ...
                    <?php if (!empty($employee_salary_info)): ?>
                        ...
                        <tr>
                            ...
                            <td> &nbsp; <?php
                                ...
                                echo '<Span style="color:red;font-weight:900;">- </span>'.display_money($total_deduction, $curency->symbol);
                                ?></td>
                        </tr>
                    <?php endif; ?>
                    <?php if (!empty($employee_salary_info)): ?>
                    ...
                    <?php if (!empty($employee_salary_info->fine_deduction)): ?>
                        <tr>
                            <td style="text-align: right"><strong><?= lang('Additional Deduction') ?> :&nbsp;&nbsp;</strong>
                            </td>

                            <td>&nbsp; <?php
                                $net_salary = $gross - $deduction;
                                echo '<Span style="color:red;font-weight:900;">- </span>'.display_money($employee_salary_info->fine_deduction, $curency->symbol);
                                ?></td> 
                        </tr>
                    <?php endif; ?>
                    <tr class="bg">
