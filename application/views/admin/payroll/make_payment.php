                    ...
                    <div class="panel panel-custom fees_payment">
                        ...
                        <div class="panel-body">
                            <div class="">
                                ...
                                ?>"
                                       class="salary form-control gross_salary" id="gross_salary">
                            </div>
                            <?php
                            if (empty($main)) {
                                $main = 0;
                            ...
                            <div class="">
                                <label class="control-label"><?= lang('Pre Deductions (As per salary Grade) ') ?> </label>
                                <input type="text" name=""  disabled value="<?php
                                echo $deduction_info;
                                ?>" class="salary form-control pre_deducation" id="pre_deducation">
                            </div>

                            <div class="">
                                <label class="control-label"><?= lang('Advance ') ?> </label>
                                <input type="text" name=""  disabled value="<?php
                                echo $advance_amount;
                                ?>" class="salary form-control pre_advance" id="pre_advance">
                            </div>                          

                         <div class="">
                                <label class="control-label"><?= lang('Absent Deduction') ?> </label>
                                <input type="text" name="absent_deduction"  value="<?php
                                echo $total_absent_salary;
                                ?>" class="salary form-control absent_deduction" ID="absent_deduction">
                            </div>

                            <div class="">
                                <label class="control-label"><?= lang('Total Deduction ') ?> </label>
                                <input type="number" name=""  disabled value="<?php
                                echo $deduction =  $deduction_info + $advance_amount + $total_absent_salary;
                                ?>" class="salary form-control new_deducation">

               <input type="hidden" name="hidden_total_deducation"  value="<?php
                                echo $deduction =  $deduction_info + $advance_amount + $total_absent_salary;
                                ?>" class="salary form-control hidden_total_deducation" id="hidden_total_deducation">
                            </div>
      
                            <div class="">
                                <label class="control-label"><?= lang('net_salary') ?> </label>
                                <input type="text" id="net_salary" disabled name="other_allowance"  value="<?php
                                echo $net_salary = $gross - ($deduction_info + $advance_amount + $total_absent_salary);
                                ?>"
                                       class="salary form-control net_salary ">
                            ...
                            <div class="">
                                <label class="control-label"><?= lang('Additional Deduction') ?> </label>
...
<script type="text/javascript">
    ...
    $(document).on("change", function () {
     ...
     $(document).on("change", function () {
        ...
        var finey = 0;
        absent_deduction = $("#absent_deduction").val();
        pre_deducation = $("#pre_deducation").val();
        pre_advance = $("#pre_advance").val();
        gross_salary = $("#gross_salary").val();

        net_new_salary = parseFloat(gross_salary) - parseFloat(absent_deduction) - parseFloat(pre_deducation) - parseFloat(pre_advance);

        var totaly = parseFloat(absent_deduction) + parseFloat(pre_deducation) + parseFloat(pre_advance);

        $(".new_deducation").val(totaly);

        $(".net_salary").val(net_new_salary);
    });
