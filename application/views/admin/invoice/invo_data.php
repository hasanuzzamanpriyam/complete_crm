            ...
            <div class="panel widget">
                <div class="pl-sm pr-sm pb-sm">
                    ...
                    <div class="progress progress-striped progress-xs mb-sm">
                        <div class="progress-bar progress-bar-danger " data-toggle="tooltip" data-original-title="<?= ($not_paid / count(array($all_invoices))) * 100 ?>%" style="width: <?= ($not_paid / count(array($all_invoices))) * 100 ?>%"></div>
                    </div>
                </div>
            </div>
            <!-- END widget-->
