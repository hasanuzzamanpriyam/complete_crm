...
if (!empty($comment_reply_details)) {
    foreach ($comment_reply_details as $v_reply) {
        ...
        ?>
<div id="<?php echo $comment_reply_type . "-comment-form-container-" . $v_reply->tickets_replies_id ?>"> <div class="col-sm-1"></div> <div class="mb-mails col-sm-11"><img alt="Mail Avatar" src="<?php echo base_url(get_avatar_url($r_profile_info->avatar ?? null)) ?>" class="mb-mail-avatar pull-left"> <div class="mb-mail-date pull-right"><?= time_ago($v_reply->time) ?>
