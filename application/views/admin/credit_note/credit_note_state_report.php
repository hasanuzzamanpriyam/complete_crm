                ...
                <div class="pl-sm pr-sm pb-sm">
                    <strong><a class="text-purple filter_by_type" style="font-size: 15px"
                        ...
                        <small class="pull-right " style="padding-top: 2px"> <?= $open ?>
                            / <?= count(array($all_credit_note)) ?></small>
                    </strong>
                    <div class="progress progress-striped progress-xs mb-sm">
                        <div class="progress-bar progress-bar-primary " data-toggle="tooltip"
                             data-original-title="<?= ($open / count(array($all_credit_note))) * 100 ?>%"
                             style="width: <?= ($open / count(array($all_credit_note))) * 100 ?>%"></div>
                    </div>
                </div>
            </div>
            <!-- END widget-->
        ...
        <div class="col-lg-3">
            ...
            <div class="panel widget">
                <div class="pl-sm pr-sm pb-sm">
                    ...
                    <div class="progress progress-striped progress-xs mb-sm">
                        <div class="progress-bar progress-bar-primary " data-toggle="tooltip"
                             data-original-title="<?= ($closed / count(array($all_credit_note))) * 100 ?>%"
                             style="width: <?= ($closed / count(array($all_credit_note))) * 100 ?>%"></div>
                    </div>
                </div>
            </div>
            <!-- END widget-->
        ...
        <div class="col-lg-3">
            ...
            <div class="panel widget">
                <div class="pl-sm pr-sm pb-sm">
                    ...
                    <div class="progress progress-striped progress-xs mb-sm">
                        <div class="progress-bar progress-bar-primary " data-toggle="tooltip"
                             data-original-title="<?= ($refund / count(array($all_credit_note))) * 100 ?>%"
                             style="width: <?= ($refund / count(array($all_credit_note))) * 100 ?>%"></div>
                    </div>
                </div>
            </div>
            <!-- END widget-->
                ...
                <div class="pl-sm pr-sm pb-sm">
                    ...
                    <div class="progress progress-striped progress-xs mb-sm">
                        <div class="progress-bar progress-bar-warning " data-toggle="tooltip"
                             data-original-title="<?= ($void / count(array($all_credit_note))) * 100 ?>%"
                             style="width: <?= ($void / count(array($all_credit_note))) * 100 ?>%"></div>
                    </div>
                </div>
            </div>
            <!-- END widget-->
