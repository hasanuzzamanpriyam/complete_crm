            ...
            <tr>
                ...
                <td class="th1"><?php
                    if (!empty($total_attend)) {
                        $total_working_days = count(array($dateSl));
        ...
        <tr>
            ...
            <?php foreach ($dates as $edate) : ?>
                <td class="th1 th" style="text-align: left">
                    <?php
                    echo !empty($total_attendence[$edate]) ? count(array($total_attendence[$edate])) : 0;
                    ?>
                </td>
            <?php endforeach; ?>
        </tr>
            ...
            <?php foreach ($dates as $edate) : ?>
                <td class="th1 th" style="text-align: left">
                    ...
                    if (!empty($total_attendence[$edate])) {
                        $total_attendence[$edate] = count(array($total_attendence[$edate]));
                        $total_attendence[$edate] = ($total_attendence[$edate] / count(array($employee))) * 100;
