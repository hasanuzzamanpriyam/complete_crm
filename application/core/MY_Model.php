<?php class MY_Model extends CI_Model
{
    ...
    public function all_files()
    {
        $language = array(
            ...
            "email_lang.php" => APPPATH,
            "form_validation_lang.php" => APPPATH,
            "ftp_lang.php" => APPPATH,
            "imglib_lang.php" => APPPATH,
            "leads_lang.php" => APPPATH,
            "leave_management_lang.php" => APPPATH,
            "main_lang.php" => APPPATH,
            "migration_lang.php" => APPPATH,
            "number_lang.php" => APPPATH,
            "opportunities_lang.php" => APPPATH,
            "pagination_lang.php" => APPPATH,
            "payroll_lang.php" => APPPATH,
            "profiler_lang.php" => APPPATH,
            "performance_lang.php" => APPPATH,
            "projects_lang.php" => APPPATH,
            "sales_lang.php" => APPPATH,
            "settings_lang.php" => APPPATH,
            "stock_lang.php" => APPPATH,
            "tasks_lang.php" => APPPATH,
            "tickets_lang.php" => APPPATH,
            "transactions_lang.php" => APPPATH,
            "unit_test_lang.php" => APPPATH,
            "upload_lang.php" => APPPATH,
            "utilities_lang.php" => APPPATH,
        );
        return $language;
    }
