    ...
    <div class="panel-body chat" id="chat-box">
        <form action="<?= base_url('admin/' . $module . '/save_task') ?>/<?php if (!empty($task_info->task_id)) echo $task_info->task_id; ?>"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <div class="input-group">
                        <select name="category_id" class="form-control select_box">
                            <?php
                        ...
                        <?php if (!empty($created)) { ?>
                            <div class="input-group-addon" title="<?= lang('new') . ' ' . lang('categories') ?>"
                                 data-toggle="tooltip" data-placement="top">
                                <a data-toggle="modal" data-target="#myModal"
                                   href="<?= base_url() ?>admin/tasks/new_category"><i class="fa fa-plus"></i></a>
                            </div>
                        <?php } ?>
                    </div>
                </div>
            ...
            if (!empty($task_info->leads_id)) {
                ...
                $leads_id = $leads_id; ?>
                <input type="hidden" name="un_leads_id" required class="form-control" value="<?php echo $leads_id ?>"/>
            <?php }
            if (!empty($task_info->bug_id)) {
                $bug_id = $task_info->bug_id;
            } elseif (!empty($bug_id)) {
                $bug_id = $bug_id; ?>
                <input type="hidden" name="un_bug_id" required class="form-control" value="<?php echo $bug_id ?>"/>
            <?php }
            ...
            <?php if (empty($project_id)) { ?>
                <div class="form-group company" id="milestone_show">
                    ...
                    <div class="col-sm-5">
                        <select name="milestones_id" id="milestone" class="form-control company">
                            <?php
                            if (!empty($project_id)) {
                ...
                <div class="form-group <?= $project_id ? 'project_module' : 'company' ?>">
                    ...
                    <div class="col-sm-5">
                        <select name="project_id"
                                class="select_box <?= $project_id ? 'project_module' : 'company' ?>" required="1"
                                onchange="get_milestone_by_id(this.value)">
                            <?php
            ...
            <?php if (!empty($opportunities_id)) : ?>
                <div class="form-group <?= $opportunities_id ? 'opportunities_module' : 'company' ?>" id="border-none">
                    <label for="field-1"
                           class="col-sm-3 control-label"><?= lang('select') . ' ' . lang('opportunities') ?>
                        <span class="required">*</span></label>
                    <div class="col-sm-5">
                        <select name="opportunities_id"
            ...
            <?php if (!empty($leads_id)) : ?>
                <div class="form-group <?= $leads_id ? 'leads_module' : 'company' ?>" id="border-none">
                    <label for="field-1" class="col-sm-3 control-label"><?= lang('select') . ' ' . lang('leads') ?>
                        <span class="required">*</span></label>
                    <div class="col-sm-5">
                        <select name="leads_id"
                                class="select_box <?= $leads_id ? 'leads_module' : 'company' ?>" required="1">
                            <?php
            ...
            <?php if (!empty($bug_id)) : ?>
                <div class="form-group <?= $bug_id ? 'bugs_module' : 'company' ?>" id="border-none">
                    <label for="field-1" class="col-sm-3 control-label"><?= lang('select') . ' ' . lang('bugs') ?>
                        <span class="required">*</span></label>
                    <div class="col-sm-5">
                        <select name="bug_id"
                                class="select_box <?= $bug_id ? 'bugs_module' : 'company' ?>" required="1">
                            <?php
            ...
            <?php if (!empty($goal_tracking_id)) : ?>
                <div class="form-group <?= $goal_tracking_id ? 'goal_tracking' : 'company' ?>" id="border-none">
                    <label for="field-1"
                           class="col-sm-3 control-label"><?= lang('select') . ' ' . lang('goal_tracking') ?>
                        <span class="required">*</span></label>
                    <div class="col-sm-5">
                        <select name="goal_tracking_id"
                                class="select_box <?= $goal_tracking_id ? 'goal_tracking' : 'company' ?>" required="1">
                            <?php
            ...
            <?php if (!empty($sub_task_id)) : ?>
                <div class="form-group <?= $sub_task_id ? 'sub_tasks' : 'company' ?>" id="border-none">
                    <label for="field-1" class="col-sm-3 control-label"><?= lang('select') . ' ' . lang('tasks') ?>
                        <span class="required">*</span></label>
                    <div class="col-sm-5">
                        <select name="sub_task_id"
                                class="select_box <?= $sub_task_id ? 'sub_tasks' : 'company' ?>" required="1">
                            <?php
            ...
            <?php if (!empty($transactions_id)) : ?>
                <div class="form-group <?= $transactions_id ? 'expenses' : 'company' ?>" id="border-none">
                    <label for="field-1" class="col-sm-3 control-label"><?= lang('select') . ' ' . lang('expenses') ?>
                        <span class="required">*</span></label>
                    <div class="col-sm-5">
                        <select name="transactions_id"
                                class="select_box <?= $transactions_id ? 'expenses' : 'company' ?>" required="1">
                            <?php
