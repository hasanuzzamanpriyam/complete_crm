...
$open = 0;
$in_progress = 0;
$progress_tickets_info = $this->complaints_model->get_permission('tbl_complaints');
...
for ($iDay = 30; $iDay >= 0; $iDay--) {
    ...
    $tickets_result[$date] = count($this->db->where($where)->get('tbl_complaints')->result());
}
...
if ($this->session->userdata('user_type') == 1) {
    ?>
    <div class="col-sm-12 bg-white p0 report_menu mt">
        <div class="col-md-4">
                ...
                <div class="col-xs-6">
                    ...
                    <p class="m0">
                        <small><a class="filter_by_type" id="answered"
                                  href="#"> <?= lang('answered') . ' ' . lang('complaints') ?></a>
                        </small>
                    </p>
                </div>
                <div class="col-xs-6">
                    ...
                    <p class="m0">
                        <small><a class="filter_by_type" id="in_progress"
                                  href="#"><?= lang('in_progress') . ' ' . lang('complaints') ?></a>
                        </small>
                    </p>
                </div>
                ...
                <div class="col-xs-6">
                    ...
                    <p class="m0">
                        <small><a class="filter_by_type" id="open"
                                  href="#"><?= lang('open') . ' ' . lang('complaints') ?></a>
                        </small>
                    </p>
                </div>
                <div class="col-xs-6">
                    ...
                    <p class="m0">
                        <small><a class="filter_by_type" id="closed"
                                  href="#"><?= lang('close') . ' ' . lang('complaints') ?></a>
                        </small>
                    </p>
                </div>
        ...
        <div class="col-md-5">
            <div class="row row-table text-center pt">
                <div data-sparkline="" data-bar-color="#23b7e5" data-height="60" data-bar-width="7" data-bar-spacing="6"
                     data-chart-range-min="0" values="<?php
